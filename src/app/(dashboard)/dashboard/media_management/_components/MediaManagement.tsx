...
//   const [deleteModalOpen, setDeleteModalOpen] = useState(false);
//   const [selectedMediaId, setSelectedMediaId] = useState<string | null>(null);
//   const [isVideoReady, setIsVideoReady] = useState<{ [key: string]: boolean }>({});
//   const itemsPerPage = 10;
...
//     },
//     onError: (err) => {
//       toast.error(err.message || "Media deletion failed!");
//     },
//   });
...
//             <TableHeader>
//               <TableRow className="border-b border-gray-600 hover:bg-transparent">
//                 <TableHead className="text-gray-300 font-medium bg-gray-700 h-12 px-4 w-[200px]">
//                   Video
//                 </TableHead>
//                 <TableHead className="text-gray-300 font-medium bg-gray-700 h-12 px-4">
//                   Serial No
...
//                   className="border-b border-[#B6B6B633] hover:bg-gray-750"
//                 >
//                   <TableCell className="text-gray-200 px-4 py-4 w-[200px]">
//                     <div className="flex items-center">
//                       {item.video ? (
//                         <div
//                           className="w-[180px] h-[101.25px] overflow-hidden rounded-lg bg-gray-800"
//                           style={{ position: "relative" }}
//                         >
//                           {!isVideoReady[item._id] && (
...
//                             aria-label={`Video for media item ${startItem + index}`}
//                             onReady={() => setIsVideoReady((prev) => ({ ...prev, [item._id]: true }))}
//                             onError={() => setIsVideoReady((prev) => ({ ...prev, [item._id]: false }))}
//                           />
//                         </div>
//                       ) : item.url ? (
//                         <a
...
//                           target="_blank"
//                           rel="noopener noreferrer"
//                           className="text-blue-400 underline hover:text-blue-300 w-[180px] truncate"
//                         >
//                           {item.url}
//                         </a>
//                       ) : (
