  ...
  return (
    <div className='text-white space-y-[24px] px-12 py-10'>
      ...
      <div className='flex p-2 cursor-pointer rounded-lg flex-col border border-[#1F2937] bg-[#1A1A1A] gap-4'>
        <Link href='/dashboard/setting/profile' className='bg-[#252525] hover:bg-[#252525]/80 rounded-lg py-[18px] px-[16px] text-[#7DD3DD] font-semibold text-sm items-center flex gap-3'>
          <User2 />
          <p>Profile</p>
        </Link>
        <Link href='/dashboard/setting/password' className='bg-[#252525] hover:bg-[#252525]/80 rounded-lg py-[18px] px-[16px] text-[#7DD3DD] font-semibold text-sm items-center flex gap-3'>
          <Key />
          <p>Password</p>
        </Link>
      </div>
