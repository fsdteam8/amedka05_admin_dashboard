...
const navigation = [
  { name: "Dashboard", href: "/", icon: LayoutDashboard },
  {
    ...
    href: "/creators_management",
    icon: LayoutDashboard,
  },
  { name: "Creators List Page ", href: "/creators_list", icon: Grip },
  {
    name: "Request From Agents",
    href: "/request_from_agents",
    icon: ShoppingBasket,
  },
...
export function Sidebar() {
  ...
  return (
    <div className="flex h-screen sticky bottom-0 top-0 w-[350px] flex-col bg-[#131313] z-50 border-r border-[#424242]">
      ...
      <div className="p-3">
        <div className="flex text-red-600 items-center justify-start gap-2 space-y-1 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200 hover:bg-slate-600/50 hover:text-white cursor-pointer">
